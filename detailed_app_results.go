...
type AppResultDetails struct {
	...
	ApplicationTotalDurationMsec int      `json:"application_total_duration_msec"`
}

type AppResultData struct {
	StatusID                      int    `json:"status_id"`
	URL                           string `json:"url"`
	OutApplicationStatusID        int    `json:"out_application_status_id"`
	OutApplicationStatusName      string `json:"out_application_status_name"`
	HTTPMsg                       string `json:"http_msg"`
	ApplicationDurationMsec       int    `json:"application_duration_msec"`
	ApplicationDNSResolveTimeUsec int    `json:"application_dns_resolve_time_usec"`
}
...
type AppResults struct {
	...
	ScheduledTime    string           `json:"scheduled_time"`
	Details          AppResultDetails `json:"result"`
	Data             []AppResultData  `json:"data"`
}
type AppResultsResponse struct {
	NetworkTestResults AppResults `json:"network_test_results"`
}

func (c *Client) GetDetailedAppResults(ctx context.Context, execution_id int, sensor_id int, net_test_profile_id int) (*AppResultsResponse, error) {
