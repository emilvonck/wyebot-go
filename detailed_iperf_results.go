...
type IperfResultDetails struct {
	...
	IperfStartTime            string   `json:"iperf_start_time"`
	IsWireless                bool     `json:"is_wireless"`
	TotalDurationSeconds      int      `json:"total_duration_seconds"`
	IperfDurationSeconds      int      `json:"iperf_duration_seconds"`
	ServerInfo                string   `json:"server_info"`
}

type IperfResultData struct {
...
type IperfResults struct {
	...
	IperfScanResultStatusID int                `json:"iperf_scan_result_status_id"`
	IperfResultStatusName   string             `json:"iperf_result_status_name"`
	Details                 IperfResultDetails `json:"result"`
	Data                    IperfResultData    `json:"data"`
}
type IperfResultsResponse struct {
	NetworkTestResults IperfResults `json:"network_test_results"`
}

func (c *Client) GetDetailedIperfResults(ctx context.Context, execution_id int, sensor_id int, net_test_profile_id int) (*IperfResultsResponse, error) {
